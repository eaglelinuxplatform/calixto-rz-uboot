...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"emmcload=ext4load mmc 0:2 0x48080000 boot/Image;ext4load mmc 0:2 0x48000000 boot/rzg2l-calixto-optima.dtb;run prodemmcbootargs \0" \
	"sd1load=ext4load mmc 1:2 0x48080000 boot/Image;ext4load mmc 1:2 0x48000000 boot/rzg2l-calixto-optima.dtb;run prodsdbootargs \0" \
